...
- Bug in :ref:`Series.str methods <api.series.str>` would fail when using regex with lookaheads or lookbehinds on data backed by PyArrow (:issue:`60833`)
...
- Bug in :meth:`DataFrame.from_records` where the ``exclude`` parameter was ignored when ``nrows=0`` was passed (:issue:`63774`)
